...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $pass = true;
  if ($s_entertain == 49) {
    $s_entertain_err = "Um fortzufahren, müssen Sie eine Antwort eingeben.";
    $pass = false;
  }

  if ($s_difficult == 49) {
    $s_difficult_err = "Um fortzufahren, müssen Sie eine Antwort eingeben.";
    $pass = false;
  }

  if (empty($_POST["t_good"])) {
      $t_good_err = "Um fortzufahren, müssen Sie eine Antwort eingeben.";
      $pass = false;
  }

  if (empty($_POST["t_bad"])) {
      $t_bad_err = "Um fortzufahren, müssen Sie eine Antwort eingeben.";
      $pass = false;
  }

  if (empty($_POST["t_what"])) {
      $t_what_err = "Um fortzufahren, müssen Sie eine Antwort eingeben.";
      $pass = false;
  }
    ...
    <div class="base-container">
      <div class="content-container">
        ...
        <table>
          ...
          <tr>
            <td colspan="2">
              <p>Fanden sie die Aufgaben eher langweilig (0) oder eher spannend (100)?</p>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            <td colspan="2">
              <p><br>Fanden sie die Aufgaben eher einfach (0) oder eher schwierig (100)?</p>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            <td colspan="2">
              <p><br>Was fanden Sie besonders gut?</p>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            <td colspan="2">
              <p>Was fanden Sie besonders schlecht?</p>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            <td colspan="2">
              <p>Wie beurteilen Sie Ihre eigene Lösungsstrategie? Würden Sie bei einer ähnlichen Fragestellung wieder gleich vorgehen? Falls nein, was könnten Sie besser machen? Falls ja, wieso hat sich Ihr Vorgehen bewährt?</p>
            </td>
          </tr>
          <tr>
            <td colspan="2">
