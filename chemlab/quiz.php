...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($d_ans == "text" && empty($_POST["ans_text"])) {
      $at_err = "Um fortzufahren, müssen Sie eine Antwort eingeben.";
      ...
      $choice_err = "Sie müssen für jeden Becher eine Antwort abgeben.";
  } else if ($d_ans == "choices4" && $dupli_choice) {
      $choice_err = "Sie haben eine Option mehrmals ausgewählt.";
  } else if ($d_ans == "checkboxes" && $empty_choice) {
      $choice_err = "Bitte geben Sie eine kurze Beschreibung für jede ausgewählte Option an.";
  } else if ($d_conf && $a_conf == 49) {
      $slider_err = "Um fortzufahren, müssen Sie eine eingeben wie sicher Sie sich sind.";
  } else {
        ...
        <table>
          <tr>
            <td colspan="2" style="width: 100%">
              <h1 style="font-weight: bold">Frage <?php echo min(11, $progress - $offset + 1); ?></h1>
            </td>
          </tr>
          ...
          <?php if ($d_conf == true): ?>
            <tr style="height: 25px"></tr>
            <tr>
              <td colspan="2"><p>Wie sicher sind Sie sich bei Ihrer Antwort? (0-100%)</p></td>
            </tr>
            <tr>
              <td colspan="2">
